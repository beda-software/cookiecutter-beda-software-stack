...
export TEST_COMMAND=" wait-for-it.sh devbox:8080 --strict --timeout=0 -- pytest --junitxml=report.xml --cov-report html --cov-report term:skip-covered --doctest-modules --cov app ${@:-tests/}"
